  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>BOM, DOM 조작</li>
        <li>
          변수 및 함수의 유효 범위, 호이스팅, event.target 등의 실행 컨텍스트
          이해
        </li>
        <li>
          비동기 함수 setTimeout, setInterval 실행 순서 관리를 위한 이벤트
          루프의 이해
        </li>
        <li>
          Promise, fetch, async/await를 이용한 데이터 처리 및 통신 구현 및
          작업의 효율성 향상
        </li>
      </ul>
      ...
      <ul>
        <li>
          Express 프레임워크를 이용한 서버 구축 및 API를 통한 클라이언트와의
          데이터 통신
        </li>
        <li>
          express-session, cors, static, json 등 다양한 Express의 미들웨어 활용
        </li>
      </ul>
